...
const loadArticle = async () => {
    // 获取文章信息
    let resArticle = await axios.get(`article/detail?articleType=attractionarticle&id=${route.query.id}`)
...
const toDelete = async (blog) => {
    ...
    ElMessageBox.confirm(
        ...
        .then(async () => {
            let res = await axios.delete(`article/delete?articleType=attractionarticle&id=${articleInfo.value.id}`)
